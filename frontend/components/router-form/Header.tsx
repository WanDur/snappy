...
import { PlatformPressable, type HeaderButtonProps } from '@react-navigation/elements'
import React from 'react'
import { Platform, StyleSheet } from 'react-native'

export const HeaderButton = React.forwardRef(function HeaderButton(
  { disabled, onPress, pressColor, pressOpacity, accessibilityLabel, testID, style, href, children }: HeaderButtonProps,
  ref: React.Ref<any>
) {
  return (
    <PlatformPressable
