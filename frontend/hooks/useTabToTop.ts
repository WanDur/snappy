...
export function useScrollToTop(ref: React.RefObject<ScrollableWrapper> | React.RefObject<WebView>, offset: number = 0) {
          ...
          requestAnimationFrame(() => {
            ...
            if (isFocused && isFirst && scrollable && !e.defaultPrevented) {
              if ('scrollToTop' in scrollable) {
                ...
                scrollable.injectJavaScript(`;window.scrollTo({ top: ${offset}, behavior: 'smooth' }); true;`)
              }
            }
          })
        }
